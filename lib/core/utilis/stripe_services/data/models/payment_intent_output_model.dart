...
//
//     final outputPaymentIntentModel = outputPaymentIntentModelFromJson(jsonString);

import 'dart:convert';

OutputPaymentIntentModel outputPaymentIntentModelFromJson(String str) =>
    OutputPaymentIntentModel.fromJson(json.decode(str));

String outputPaymentIntentModelToJson(OutputPaymentIntentModel data) =>
    json.encode(data.toJson());

class OutputPaymentIntentModel {
  final String id;
  final String object;
  final int amount;
  ...
  factory OutputPaymentIntentModel.fromJson(Map<String, dynamic> json) =>
      OutputPaymentIntentModel(
        id: json["id"],
        object: json["object"],
        amount: json["amount"],
